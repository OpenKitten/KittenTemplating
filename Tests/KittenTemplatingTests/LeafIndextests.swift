...
class IndexTests: XCTestCase {
    ...
    func testBasicIndex() throws {
        ...
        let renderedBytes = try template.run(inContext: ["friends": ["Joe", "Jan", "Jay", "Jen"] as Document, "idx": 3])
    ...
    func testOutOfBounds() throws {
        ...
        let renderedBytes = try template.run(inContext: ["friends": [] as Document, "idx": 3])
